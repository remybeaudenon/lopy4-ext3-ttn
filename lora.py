...
class LORAWAN : 
    ...
    def join(self) : 
        ...
        #self.lora.join(activation=LoRa.OTAA,  auth=(LORAWAN.APP_EUI , LORAWAN.APP_KEY), timeout=0, dr=0)
        self.lora.join(activation=LoRa.OTAA, auth=(LORAWAN.APP_EUI , LORAWAN.APP_KEY), timeout=0)
