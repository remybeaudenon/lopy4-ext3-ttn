...
class Logger(Persist) :
    ...
    def checkFileSize(self) :
        ...
        try :
            ...
            self.log('Logger:checkFileSize()' ,'ERROR:{}  File {}'.format(err, ""+ self.path + fileName))
        else :
            ...
            if (filesize > Logger.__fileSize * 1000  ) :
                ...
                try :
                    os.remove(""+self.path + self.getLogFileName() )
                    self.log('Logger:checkFileSize()','New Rolling file index {} new file {}'.format(idx,self.getLogFileName() ) )
                except OSError as ex :
                    pass
